...
},
{
  ...
  "number": "2.2.13",
  "title": "",
  "body": "  Do the math problems in questions 1-12 above using your calculator. You probably have a SCI and DEC button or mode on your calculator. If you need help figuring out how to do these on your calculator, please reach out to your instructor or find an online tutorial that is specific to your calculator model.      Same answers as above     "
},
{
...
},
{
  ...
  "body": " Conversion factors    Conversion factors    Fractions that can be used to convert between units or to cancel out unwanted units    Can be flipped    Equivalencies can be written as conversion factors    Conversion factors can be provided in text format       Conversion factors   Anytime we are converting from one type of unit to another, we use conversion factors, even if we don’t realize that’s what we’re doing. Conversion factors are fractions that express the relationship between two different units as a fraction. For instance, the relationship between feet and inches can be expressed by an equation:     This same relationship can be expressed as a conversion factor by taking one side of the equation and placing it over the other side as a fraction:     By multiplying these conversion factors with a given quantity, we can cancel out the units we don’t want, leaving us with the ones that we do.  Conversion factors are often provided in chemistry problems. For instance, the density of a substance may be provided as 220 grams per liter (or written out using abbreviations as 220 g\/L). In either case, this quantity should be written as a fraction, allowing it to be used as a conversion factor:        Identify the conversion factors that you used in each problem from the previous section (shown below), then do the same problems from exercise 1, but this time write out the necessary math using those conversion factors.     How many inches are in 4.0 ft?    Conversion factors:   Math:       A pizza restaurant puts 14 pepperonis on a pizza. How many pepperonis are needed for 10 pizzas?    Conversion factors:   Math:       A bicycle needs two wheels. Each wheel weighs 2.0 pounds. How many pounds of wheels are on a single bike?    Conversion factors: and   Math:       A bicycle needs two wheels. Each wheel weighs 2.0 pounds. How many pounds of bike wheels are in a race with 50 bikes?    Conversion factors: same as previous problem  Math:       A 50. kg patient has eats 2.0 pounds of food. Each pound of food contains 1200 Calories. How many Calories did the patient consume?    Conversion factors:   Math:       A section of forest was logged and 150 tons of lumber was obtained. If a tree can give 3.0 tons of lumber, how many trees were harvested?    Conversion factor:   Math:       "
},
{
  "id": "sec-math8-3",
  "level": "2",
  "url": "sec-math8.html#sec-math8-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "sec-math8-4",
  "level": "2",
  "url": "sec-math8.html#sec-math8-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Conversion factors "
...
{
  "id": "exercises-math8-1-2",
  "level": "2",
  "url": "sec-math8.html#exercises-math8-1-2",
  "type": "Exercise",
  "number": "2.8.1",
  "title": "",
  "body": "  How many inches are in 4.0 ft?    Conversion factors:   Math:    "
},
{
  "id": "exercises-math8-1-3",
  "level": "2",
  "url": "sec-math8.html#exercises-math8-1-3",
  "type": "Exercise",
  "number": "2.8.2",
  "title": "",
  "body": "  A pizza restaurant puts 14 pepperonis on a pizza. How many pepperonis are needed for 10 pizzas?    Conversion factors:   Math:    "
},
{
  "id": "exercises-math8-1-4",
  "level": "2",
  "url": "sec-math8.html#exercises-math8-1-4",
  "type": "Exercise",
  "number": "2.8.3",
  "title": "",
  "body": "  A bicycle needs two wheels. Each wheel weighs 2.0 pounds. How many pounds of wheels are on a single bike?    Conversion factors: and   Math:    "
},
{
  "id": "exercises-math8-1-5",
  "level": "2",
  "url": "sec-math8.html#exercises-math8-1-5",
  "type": "Exercise",
  "number": "2.8.4",
  "title": "",
  "body": "  A bicycle needs two wheels. Each wheel weighs 2.0 pounds. How many pounds of bike wheels are in a race with 50 bikes?    Conversion factors: same as previous problem  Math:    "
},
{
  "id": "exercises-math8-1-6",
  "level": "2",
  "url": "sec-math8.html#exercises-math8-1-6",
  "type": "Exercise",
  "number": "2.8.5",
  "title": "",
  "body": "  A 50. kg patient has eats 2.0 pounds of food. Each pound of food contains 1200 Calories. How many Calories did the patient consume?    Conversion factors:   Math:    "
},
{
  "id": "exercises-math8-1-7",
  "level": "2",
  "url": "sec-math8.html#exercises-math8-1-7",
  "type": "Exercise",
  "number": "2.8.6",
  "title": "",
  "body": "  A section of forest was logged and 150 tons of lumber was obtained. If a tree can give 3.0 tons of lumber, how many trees were harvested?    Conversion factor:   Math:    "
},
{
  "id": "sec-math9",
  "level": "1",
...
},
{
  ...
  "level": "2",
  "url": "sec-math9.html#assemblage-math9-1-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Question: "
...
{
  "id": "assemblage-math9-1-3",
  "level": "2",
  "url": "sec-math9.html#assemblage-math9-1-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Starting information "
},
{
  "id": "assemblage-math9-1-4",
  "level": "2",
  "url": "sec-math9.html#assemblage-math9-1-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Desired end units "
},
{
  "id": "assemblage-math9-1-5",
  "level": "2",
  "url": "sec-math9.html#assemblage-math9-1-5",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Relevant equation and conversion factors "
},
{
  "id": "assemblage-math9-1-7",
  "level": "2",
  "url": "sec-math9.html#assemblage-math9-1-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Pathway "
...
{
  "id": "assemblage-math9-1-8",
  "level": "2",
  "url": "sec-math9.html#assemblage-math9-1-8",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Calculation "
...
},
{
  "id": "sec-math9-11",
  "level": "2",
  "url": "sec-math9.html#sec-math9-11",
  "type": "Table",
  "number": "2.9.1",
  "title": "",
  "body": "      SI unit and abbreviation  Unit of…    meter (m)  distance    liter (L)  volume     gram (g) Technically the kilogram is the base unit; but gram is the form lacking a prefix     mass     Joule (J)  energy    second (sec)  time    Kelvin (K)  temperature    Pascal (Pa)  pressure    "
},
{
  "id": "sec-math9-13",
  "level": "2",
  "url": "sec-math9.html#sec-math9-13",
  "type": "Table",
  "number": "2.9.2",
  "title": "",
...
},
{
  "id": "sec-atoms1-3",
  "level": "2",
  "url": "sec-atoms1.html#sec-atoms1-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "sec-atoms1-4-2-1",
  "level": "2",
  "url": "sec-atoms1.html#sec-atoms1-4-2-1",
  "type": "Exercise",
  "number": "4.1.1",
  "title": "",
...
},
{
  "id": "sec-atoms2-3",
  "level": "2",
  "url": "sec-atoms2.html#sec-atoms2-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": " Atomic number  "
...
},
{
  ...
  "number": "4.4",
  "title": "Atomic Mass",
  "body": " Atomic Mass  At the bottom of a square in the periodic table is the value of the  atomic mass  in units of amu. Look at this number for carbon (12.011). This number is clearly different than the mass number since it is not an integer. However, the calculation used to determine the atomic mass of an element relies on the mass numbers of the naturally occurring isotopes. To calculate atomic mass, we calculate the  weighted average  of the various isotopes that are found in nature.  What is a weighted average? It is a way of averaging that takes into account how frequently each isotope occurs in nature. For instance, if a class of 5 students had the following exam scores: 90, 80, 90, 90, 90, you would not simply average 80 and 90 to find the average. Instead, you would add up each of the numbers and then divide by 5:   Another way of doing this is to weight each of the scores by writing how frequently it occurs:   Since 90 occurred 4 times, we can multiply it by 4 and then add 80 rather than adding 90 four times. Alternatively, you could reach the same result by knowing that 20% of the class got an 80 and 80% of the class scored a 90. To use the percentages, we can assume that we have any class size, but assuming a class size of 100 people makes the calculation easiest. If we had 100 students in the class, then 20 of them would have a score of 80 and 80 of them would have a score of 90. We would multiply each score by the values of these percentages and then divide the result by the number of students that we assumed were in the class (100). The calculation would look like this and gives the exact same result:   When we calculate the atomic mass, we do a similar thing. Similar to the example above, we have percent abundances for each element. To use percentages in a weighted average, we assume that if we had 100 isotopes, the value of the percentage is how many isotopes would have that mass. If we multiply each mass number by its percent occurrence, add them together, and then divide by 100, then we get the atomic mass.   Calculating an Atomic Mass   If an element has the following isotopes that are found in nature, calculate the atomic mass of the element:     Mass number  Percent abundance  Number of isotopes with that mass in a group of 100 isotopes    44  15.5  15.5    46  34.5  34.5    47  50.0  50.0       Take each mass number and multiply it by the number of isotopes of that mass expected in a group of 100 isotopes. Add the masses together and divide by the total number of isotopes being averaged (100).   Do not worry about significant figures for these calculations.     Exercises: Atomic Mass     Calculate the atomic mass of an element with the following isotopes. Round your answer to the tenths place.     Mass number  Percent abundance    72  3.1    73  44.9    74  52.0              Chlorine has two major isotopes, one with a mass of 35 and the other with a mass of 37. Based on the atomic mass of chlorine, which isotope is more abundant? Explain.    Chlorine-35; the atomic mass is closer to 35 than to 37.      Calculate the atomic mass of an element with the following isotopes. Round your answer to the tenths place.     Mass number  Percent abundance    101  12.0    103  38.5    104  40.5    106  9.0              "
},
{
  "id": "sec-atoms4-2",
  "level": "2",
...
{
  "id": "ch4-l2-atomic-mass-example",
  "level": "2",
  "url": "sec-atoms4.html#ch4-l2-atomic-mass-example",
  "type": "Example",
  "number": "4.4.1",
  "title": "Calculating an Atomic Mass.",
  "body": " Calculating an Atomic Mass   If an element has the following isotopes that are found in nature, calculate the atomic mass of the element:     Mass number  Percent abundance  Number of isotopes with that mass in a group of 100 isotopes    44  15.5  15.5    46  34.5  34.5    47  50.0  50.0       Take each mass number and multiply it by the number of isotopes of that mass expected in a group of 100 isotopes. Add the masses together and divide by the total number of isotopes being averaged (100).   Do not worry about significant figures for these calculations.   "
},
{
  "id": "sec-atoms4-11-2-1",
  "level": "2",
  "url": "sec-atoms4.html#sec-atoms4-11-2-1",
  "type": "Exercise",
  "number": "4.4.1",
  "title": "",
  "body": "  Calculate the atomic mass of an element with the following isotopes. Round your answer to the tenths place.     Mass number  Percent abundance    72  3.1    73  44.9    74  52.0           "
},
{
  "id": "sec-atoms4-11-2-2",
  "level": "2",
  "url": "sec-atoms4.html#sec-atoms4-11-2-2",
  "type": "Exercise",
  "number": "4.4.2",
  "title": "",
  "body": "  Chlorine has two major isotopes, one with a mass of 35 and the other with a mass of 37. Based on the atomic mass of chlorine, which isotope is more abundant? Explain.    Chlorine-35; the atomic mass is closer to 35 than to 37.   "
},
{
  "id": "sec-atoms4-11-2-3",
  "level": "2",
  "url": "sec-atoms4.html#sec-atoms4-11-2-3",
  "type": "Exercise",
  "number": "4.4.3",
  "title": "",
  "body": "  Calculate the atomic mass of an element with the following isotopes. Round your answer to the tenths place.     Mass number  Percent abundance    101  12.0    103  38.5    104  40.5    106  9.0           "
},
{
  "id": "sec-atoms5",
  "level": "1",
  ...
  "body": " Electron Shells  We have learned that electrons can be found in atoms and that they exist outside of the nucleus. This fact makes them the most important subatomic particle when we are trying to understand the reactivity properties of an atom. If two atoms are going to interact with one another, their electrons are going to be the type of subatomic particle that will first interact between the atoms. In order to make sense of the reactivity properties of atoms, we need to understand how electrons are arranged around an atom.  Niels Bohr came up with the first model of the atom that sought to explain where the electrons are around the nucleus. His model sought to do two things: (1) explain why negatively charged electrons do not fall into the positively charged nucleus and (2) explain why hydrogen is able to emit light with very specific amounts of energy. His model proposed the idea that the electrons in an atom are placed into orbits around the nucleus, similar to satellites around Earth. If the electrons move fast enough, then they will never fall into the nucleus. Also, if we know the mass of an electron and its velocity, we can calculate the amount of energy that an electron has in its orbit. Electrons in different orbits would have different velocities and thus different amounts of energy. The observation that hydrogen emits light with specific energies could be explained if electrons hopped from one orbit to another, giving off their excess energy as light.  The key contribution of the Bohr model of the atom is the idea that electrons exist within  electron shells  around the atom. These shells are numbered 1, 2, 3, 4, and so on. Higher-numbered shells are farther from the nucleus and contain electrons with greater energies.   Electron Removal Energies and Electron Shells   A graph of energy required to remove an electron versus electrons removed. The plotted electrons form distinct groups at different energy levels, illustrating that electrons occupy shells with similar energies. Lower-energy groups are farther from the nucleus, while higher-energy groups are closer to the nucleus.    What discovery gave rise to the idea of electron shells in an atom? Scientists can use x-rays to measure the amount of energy required to remove an electron from an atom. What is seen with larger atoms is that there are certain electrons that can be removed using relatively low energies. However, there are other groups of electrons that require even more energy to remove. As shown in , different groups of electrons require different amounts of energy to remove. This was explained by a model where the electrons are placed into different shells around the nucleus. The outer shells are farther from the nucleus and thus the electrons are more loosely bound to the atom and easier to remove. Electrons in inner shells are closer to the nucleus, and thus more strongly held to the atom, and therefore require more energy to remove.  How many electrons can each shell hold? Lower shell numbers are closer to the nucleus, and thus have less room for electrons than higher-numbered shells. Each shell is capable of holding a certain number of electrons, and this is given by the equation:   So the first shell can hold electrons, the second can hold electrons, and so on.   Exercises: Electron Shells     Electrons in ___________ (inner\/outer) shells are more easily removed from an atom.    Inner.      Electrons in the 1st shell are ________________ (closer\/farther) from the nucleus than electrons in the 3rd shell.    Closer.      Explain the discovery that led scientists to develop the model of electron shells.    When we measure the amount of energy required to remove electrons from an atom, we see groups of electrons that require similar energies to remove. However, different groups of electrons have different energies, implying that these groups are closer to or farther from the nucleus.      Determine the number of electrons in the 1st, 2nd, 3rd, and 4th shells.    2, 8, 18, 32.      "
},
{
  "id": "sec-atoms5-4",
  "level": "2",
  "url": "sec-atoms5.html#sec-atoms5-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": " electron shells  "
},
{
  "id": "fig-electron-shell-ionization-energy",
  "level": "2",
  "url": "sec-atoms5.html#fig-electron-shell-ionization-energy",
  "type": "Figure",
  "number": "4.5.1",
  "title": "",
  "body": " Electron Removal Energies and Electron Shells   A graph of energy required to remove an electron versus electrons removed. The plotted electrons form distinct groups at different energy levels, illustrating that electrons occupy shells with similar energies. Lower-energy groups are farther from the nucleus, while higher-energy groups are closer to the nucleus.   "
},
{
  "id": "sec-atoms5-10-2-1",
  "level": "2",
  "url": "sec-atoms5.html#sec-atoms5-10-2-1",
  "type": "Exercise",
  "number": "4.5.1",
  "title": "",
  "body": "  Electrons in ___________ (inner\/outer) shells are more easily removed from an atom.    Inner.   "
},
{
  "id": "sec-atoms5-10-2-2",
  "level": "2",
  "url": "sec-atoms5.html#sec-atoms5-10-2-2",
  "type": "Exercise",
  "number": "4.5.2",
  "title": "",
  "body": "  Electrons in the 1st shell are ________________ (closer\/farther) from the nucleus than electrons in the 3rd shell.    Closer.   "
},
{
  "id": "sec-atoms5-10-2-3",
  "level": "2",
  "url": "sec-atoms5.html#sec-atoms5-10-2-3",
  "type": "Exercise",
  "number": "4.5.3",
  "title": "",
  "body": "  Explain the discovery that led scientists to develop the model of electron shells.    When we measure the amount of energy required to remove electrons from an atom, we see groups of electrons that require similar energies to remove. However, different groups of electrons have different energies, implying that these groups are closer to or farther from the nucleus.   "
},
{
  "id": "sec-atoms5-10-2-4",
  "level": "2",
  "url": "sec-atoms5.html#sec-atoms5-10-2-4",
  "type": "Exercise",
  "number": "4.5.4",
  "title": "",
  "body": "  Determine the number of electrons in the 1st, 2nd, 3rd, and 4th shells.    2, 8, 18, 32.   "
},
{
  "id": "sec-atoms6",
  "level": "1",
  ...
  "number": "4.6",
  "title": "Orbitals",
  "body": " Orbitals  It was later revealed that the Bohr model was sufficient in some ways. Electron shells could explain the structure of a hydrogen atom, but failed to explain the experimental data for any other element. The reason for this is that once you have more than one electron, they begin to interact with one another. This necessitated the inclusion of  orbitals  , which are regions within a shell that electrons can occupy. The idea of electron shells did not go away; instead, the theory was modified to say that shells are more complex than originally thought. Orbitals exist within each shell and define regions where electrons are likely to be.  There are different types of orbitals, and each type is a set of different shapes that electrons can occupy. The orbital sets are given the letters , , , and . The source lesson links to an external orbital-shape image at Atomic Orbital . S-orbitals are spherical in shape and occur around the nucleus. P-orbitals come in sets of 3, and each member of the set looks like a dumbbell or infinity symbol. D-orbitals come in sets of 5, with most of them looking like clovers. F-orbitals come in sets of 7 and have even more complicated shapes. You should be able to recognize and draw the s, p, and d orbital shapes and know how many come in a set.  So how do orbitals relate to shells? First, orbitals can hold 2 electrons. The s-orbital comes in groups of 1, and thus that single orbital in the set can hold 2 electrons. Each of the p-orbitals in a set of 3 can hold 2 electrons, for a total of 6 electrons. Each of the d-orbitals holds 2 electrons and since they come in sets of 5, a set of d-orbitals holds 10 electrons.  The first shell holds 2 electrons based on the formula given above. The only set of orbitals that can give two electrons is the s-orbital. So the first shell only contains one s-orbital and it is designated as the 1s orbital, meaning first-shell s-orbital. The second shell contains 8 electrons. No set of orbitals by itself can give us 8 electrons, but the combination of a set of s-orbitals and p-orbitals can together hold 8 electrons: 2 electrons from the s-orbital and 6 from the three p-orbitals. So the 2nd shell has a 2s orbital and three 2p orbitals. In order to get 18 electrons for the third shell, we need a 3s orbital, three 3p orbitals, and five 3d orbitals. For the fourth shell, a 4s orbital, three 4p orbitals, five 4d orbitals, and seven 4f orbitals are required. The 5th shell and up should require additional orbital types, but there are no known elements that require orbitals beyond the f-orbitals in the lesson's discussion.   Electron Shell and Orbital Summary    Shell  Number of electrons  Orbital types  Number of electrons in the set of orbitals    1  2  1s  2    2  8  2s  2      2p, 2p, 2p  6    3  18  3s  2      3p, 3p, 3p  6      3d, 3d, 3d, 3d, 3d  10    4  32  4s  2      4p, 4p, 4p  6      4d, 4d, 4d, 4d, 4d  10      4f, 4f, 4f, 4f, 4f, 4f, 4f  14    5  50  5s  2      5p, 5p, 5p  6      5d, 5d, 5d, 5d, 5d  10      5f, 5f, 5f, 5f, 5f, 5f, 5f  14      ?, ?, ?, ?, ?, ?, ?, ?, ? (hypothesized set of 9 orbitals)  18?      Exercises: Electron Shells and Orbitals     Without consulting the table above, what orbitals are in the first shell, 2nd shell, 3rd shell, and 4th shell?    See .      How many electrons are in the 3rd shell? How many orbitals are needed to hold that number of electrons? How can you get that number of orbitals by combining together different orbital sets?    18 electrons, 9 orbitals: 1 s-orbital, 3 p-orbitals, and 5 d-orbitals.      How many electrons can a single 4p orbital hold? How many electrons can the set of 4p orbitals hold? How many electrons can a single 5d orbital hold? How about the set of 5d orbitals?    2, 6, 2, 10.      Which orbital type has a shape similar to a ball? An hour-glass? A four-leaf clover?    S-orbital, p-orbital, d-orbital.      For the table above, make a 6th row and fill in the missing information.    The answer key gives the following:     Shell  Number of electrons  Orbital type  Number of electrons in set    6  72  6s  2      6p  6      6d  10      6f  14      ??  18?      ??  22?         "
},
{
  "id": "sec-atoms6-2",
  "level": "2",
...
{
  "id": "table-shell-orbital-summary",
  "level": "2",
  "url": "sec-atoms6.html#table-shell-orbital-summary",
  "type": "Table",
  "number": "4.6.1",
  "title": "Electron Shell and Orbital Summary",
  "body": " Electron Shell and Orbital Summary    Shell  Number of electrons  Orbital types  Number of electrons in the set of orbitals    1  2  1s  2    2  8  2s  2      2p, 2p, 2p  6    3  18  3s  2      3p, 3p, 3p  6      3d, 3d, 3d, 3d, 3d  10    4  32  4s  2      4p, 4p, 4p  6      4d, 4d, 4d, 4d, 4d  10      4f, 4f, 4f, 4f, 4f, 4f, 4f  14    5  50  5s  2      5p, 5p, 5p  6      5d, 5d, 5d, 5d, 5d  10      5f, 5f, 5f, 5f, 5f, 5f, 5f  14      ?, ?, ?, ?, ?, ?, ?, ?, ? (hypothesized set of 9 orbitals)  18?    "
},
{
  "id": "sec-atoms6-7-2-1",
  "level": "2",
  "url": "sec-atoms6.html#sec-atoms6-7-2-1",
  "type": "Exercise",
  "number": "4.6.1",
  "title": "",
  "body": "  Without consulting the table above, what orbitals are in the first shell, 2nd shell, 3rd shell, and 4th shell?    See .   "
},
{
  "id": "sec-atoms6-7-2-2",
  "level": "2",
  "url": "sec-atoms6.html#sec-atoms6-7-2-2",
  "type": "Exercise",
  "number": "4.6.2",
  "title": "",
  "body": "  How many electrons are in the 3rd shell? How many orbitals are needed to hold that number of electrons? How can you get that number of orbitals by combining together different orbital sets?    18 electrons, 9 orbitals: 1 s-orbital, 3 p-orbitals, and 5 d-orbitals.   "
},
{
  "id": "sec-atoms6-7-2-3",
  "level": "2",
  "url": "sec-atoms6.html#sec-atoms6-7-2-3",
  "type": "Exercise",
  "number": "4.6.3",
  "title": "",
  "body": "  How many electrons can a single 4p orbital hold? How many electrons can the set of 4p orbitals hold? How many electrons can a single 5d orbital hold? How about the set of 5d orbitals?    2, 6, 2, 10.   "
},
{
  "id": "sec-atoms6-7-2-4",
  "level": "2",
  "url": "sec-atoms6.html#sec-atoms6-7-2-4",
  "type": "Exercise",
  "number": "4.6.4",
  "title": "",
  "body": "  Which orbital type has a shape similar to a ball? An hour-glass? A four-leaf clover?    S-orbital, p-orbital, d-orbital.   "
},
{
  "id": "sec-atoms6-7-2-5",
  "level": "2",
  "url": "sec-atoms6.html#sec-atoms6-7-2-5",
  "type": "Exercise",
  "number": "4.6.5",
  "title": "",
  "body": "  For the table above, make a 6th row and fill in the missing information.    The answer key gives the following:     Shell  Number of electrons  Orbital type  Number of electrons in set    6  72  6s  2      6p  6      6d  10      6f  14      ??  18?      ??  22?      "
},
{
  "id": "sec-ato-ms7",
  "level": "1",
  "url": "sec-ato-ms7.html",
  "type": "Section",
  "number": "4.7",
...
},
{
  ...
  "level": "2",
  "url": "sec-ato-ms7.html#fig-orbital-filling-order",
  "type": "Figure",
  "number": "4.7.1",
  "title": "",
  "body": " Orbital Filling Order Using Diagonal Lines   A boxed three-step diagram listing orbitals by shell and drawing diagonal arrows through them to show the filling order. The sequence shown begins 1s, 2s, 2p, 3s, 3p, 4s, 3d, 4p, 5s, 4d, 5p, 6s.   "
},
{
  "id": "fig-periodic-table-orbital-blocks",
  "level": "2",
  "url": "sec-ato-ms7.html#fig-periodic-table-orbital-blocks",
  "type": "Figure",
  "number": "4.7.2",
  "title": "",
...
},
{
  "id": "sec-ato-ms8-2",
  "level": "2",
  "url": "sec-ato-ms8.html#sec-ato-ms8-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "sec-nuclear6-2",
  "level": "2",
  "url": "sec-nuclear6.html#sec-nuclear6-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Introduction "
...
},
{
  ...
  "number": "",
  "title": "",
  "body": "Chapter 2 Numerator: Denominator: Dividend: Divisor: Coefficient: Base: Exact number: Measured number: Significant figures: Analog: Digital: Conversion factors: "
},
{
  "id": "backmatter-2-4",
  "level": "2",
...
},
{
  "id": "backmatter-2-14",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-14",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Mass number: "
},
{
  "id": "backmatter-2-15",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-15",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Isotopes: "
},
{
  "id": "backmatter-2-16",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-16",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Periods: "
},
{
  "id": "backmatter-2-17",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-17",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Groups: "
},
{
  "id": "backmatter-2-18",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-18",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Atomic mass: "
},
{
  "id": "backmatter-2-19",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-19",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  "id": "backmatter-2-20",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-20",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Electron shells: "
},
{
  "id": "backmatter-2-21",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-21",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Orbitals: "
},
{
  "id": "backmatter-2-22",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-22",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Chapter 5 "
},
{
  "id": "backmatter-2-23",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-23",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Chapter 6 "
},
{
  "id": "backmatter-2-24",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-24",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Chapter 7 "
},
{
  "id": "backmatter-2-25",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-25",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Chapter 8 "
},
{
  "id": "backmatter-2-26",
  "level": "2",
  "url": "backmatter-2.html#backmatter-2-26",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Chapter 9 "
